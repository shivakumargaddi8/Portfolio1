...
def predict():
    ...
    if has_neu or (has_pos and has_neg):
        ...
        explanation = "The review contains mixed or neutral opinions."
        recommendation = "Consider improving features to increase customer satisfaction."

    elif has_pos and not has_neg:
        final_sentiment = "positive"
        explanation = "The review contains positive expressions indicating satisfaction."
        recommendation = "Maintain current service quality."

    elif has_neg and not has_pos:
        final_sentiment = "negative"
        explanation = "The review contains negative words indicating dissatisfaction."
        recommendation = "Investigate issues mentioned and improve the service."
    else:
